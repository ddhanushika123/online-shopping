package net.dd.onlineshopping.controller;
...
import net.dd.onlineshopping.util.FileUploadUtility;
import net.dd.onlineshopping.validator.ProductValidator;
import net.dd.shoppingbackend.dao.CategoryDAO;
...
public class ManagementController {
	...
	public String handleProductActivation(@PathVariable int id) {
		...
		//activating and deactivating base on the value field
	...
	//To handle the category submition
